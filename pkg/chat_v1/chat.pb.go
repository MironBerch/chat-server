...
type CreateChatRequest struct {
	...
	Usernames     []string               `protobuf:"bytes,1,rep,name=usernames,proto3" json:"usernames,omitempty"` // список участников (логины)
...
type SendMessageRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	From          string                 `protobuf:"bytes,1,opt,name=from,proto3" json:"from,omitempty"`           // отправитель
	Text          string                 `protobuf:"bytes,2,opt,name=text,proto3" json:"text,omitempty"`           // текст сообщения
	Timestamp     *timestamppb.Timestamp `protobuf:"bytes,3,opt,name=timestamp,proto3" json:"timestamp,omitempty"` // время отправки
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_chat_v1_chat_proto_rawDesc = "" +
	"\n" +
	"\x12chat_v1/chat.proto\x12\achat_v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1bgoogle/protobuf/empty.proto\"1\n" +
	...
	"\ttimestamp\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\ttimestamp2\xd2\x01\n" +
	"\vChatService\x12A\n" +
	"\x06Create\x12\x1a.chat_v1.CreateChatRequest\x1a\x1b.chat_v1.CreateChatResponse\x12<\n" +
	"\x06Delete\x12\x1a.chat_v1.DeleteChatRequest\x1a\x16.google.protobuf.Empty\x12B\n" +
	"\vSendMessage\x12\x1b.chat_v1.SendMessageRequest\x1a\x16.google.protobuf.EmptyB\x15Z\x13pkg/chat_v1;chat_v1b\x06proto3"
