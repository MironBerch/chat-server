...
const (
	ChatService_Create_FullMethodName      = "/chat_v1.ChatService/Create"
	ChatService_Delete_FullMethodName      = "/chat_v1.ChatService/Delete"
	ChatService_SendMessage_FullMethodName = "/chat_v1.ChatService/SendMessage"
)
...
type ChatServiceClient interface {
	...
	// Отправка сообщения в чат (в данном примере без указания ID чата, просто отправка)
